...
import Musicc from './vlc-record-2025-02-27-21h55m00s-Kanana-Kuyile.mp3-.mp3';
import CatCake from './images/birthday-cake-name-sreya.png'
const Surprise = () => {
